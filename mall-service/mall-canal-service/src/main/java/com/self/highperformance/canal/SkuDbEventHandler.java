...
//@Component
//@Slf4j
//public class SkuDbEventHandler {
//
//    @Autowired
//    private SkuFeign skuFeign;
//
//    @Autowired
//    SkuIndexHandler indexHandler;
//
//
//    /**
//     * ad_item表db更新even统一处理入口
//     */
//    public void dbEventHandler(CanalEntry.Entry entry) {
//        // sql执行类型
...
//                    // 更新index到elasticSearch
//                    indexHandler.addIndex(change);
//                    break;
//                }
//                case UPDATE: {
...
//                    // 删除index到elasticSearch
//                    indexHandler.delIndex(change);
//                    break;
//                }
//                default: {
